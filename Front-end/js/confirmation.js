...
let totalPriceCalculation = JSON.parse(localStorage.getItem("totalPriceCalculation")); 
...
function confirmationView (){
 ...
 `<div class="text-center mt-1 mb-2">
    ...
    Un email vous sera envoyé à l'adresse suivante ${contact.email} au moment de l'expédition. </br>  
